      ...
      static public function head_logged(){
		...
		if($_SESSION['user']['account_type'] == 'teacher'){
			...
			echo '
				<div id="menu">
					<ul>
						<li class="first"><a href="">Klasy</a></li><li><a href="">Uczniowie</a></li><li><a href="">Oceny</a></li><li><a href="">Dokumenty</a></li><li><a href="">Plan lekcji</a></li><li><a href="">Nauczyciele</a></li><li><a href="">Raporty</a></li><li><a href="">Frekwencja</a></li><li><a href="">Ustawienia</a></li><li class="last"><a href="">Wyloguj</a></li>
					</ul>
				</div>';
